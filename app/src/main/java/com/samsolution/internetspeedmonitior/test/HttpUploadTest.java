package com.samsolution.internetspeedmonitior.test;

import static com.samsolution.internetspeedmonitior.test.HttpUploadTest.uploadedKByte;   // Package name fact
